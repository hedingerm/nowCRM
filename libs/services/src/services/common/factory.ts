...
const CUSTOM_SERVICE_NAMES = ["composerService", "dalService"] as const;
...
export function getService<T extends BaseServiceName>(
	serviceName: T,
): BaseService<unknown, unknown>;
export function getService<T extends CustomServiceName>(
	serviceName: T,
): (typeof customServices)[T];
