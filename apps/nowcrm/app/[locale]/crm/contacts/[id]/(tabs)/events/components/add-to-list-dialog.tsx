...
import { massAddContactsToList } from "@/app/[locale]/crm/contacts/[id]/(tabs)/events/components/massActions/mass-add-to-list";
...
import { getContactIdByEventId } from "./massActions/get-contact-by-id";
import { currentEvents } from "./massActions/mass-actions";
