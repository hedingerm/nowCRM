...
import { columns } from "./components/columns/organization-type-columns";
import CreateOrganizationTypeDialog from "./components/create-dialog";
import OrganizationTypeMassActions from "./components/massActions/mass-actions";
