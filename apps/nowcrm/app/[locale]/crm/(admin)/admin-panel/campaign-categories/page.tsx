...
import { columns } from "./components/columns/campaign-category-columns";
import createCampaignCategoryDialog from "./components/create-dialog";
import MassActionsCampaignCategories from "./components/massActions/mass-actions";
