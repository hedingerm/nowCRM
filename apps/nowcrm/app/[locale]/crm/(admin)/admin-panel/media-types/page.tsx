...
import { columns } from "./components/columns/media-type-columns";
import CreateMediaTypeDialog from "./components/create-dialog";
import MediaTypeMassActions from "./components/massActions/mass-actions";
